...
function up_handler(event) {
    if(activePoint!=null) {
        ...
        // console.log('up handler retrain points',retrainPoints)
    }
                    ...
                    .addEventListener("click",function(){
                        ...
                        .then(blobs => {
                            ...
                            if (checkboxes[0].checked && !checkboxes[1].checked && !checkboxes[2].checked) {
                                playAudio(audio1);
                                // startTime = audio1.currentTime //* 1000
                                // audio1.addEventListener('loadeddata', () => { 
                                //     audioDuration = audio1.duration * 1000;
                                //     console.log(audioDuration)
                                //     marker.speed = 1/audioDuration
                                //     console.log('marker speed',marker.speed)
                                //     startAnimation();
                                // })
